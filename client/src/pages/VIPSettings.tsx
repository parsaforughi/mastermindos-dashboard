          ...
          <div className="flex-1 p-6 overflow-y-auto overflow-x-hidden custom-scrollbar">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 max-w-2xl">
              <Card className="p-4 border-white/10 bg-white/5 backdrop-blur-xl">
                <h3 className="text-sm font-semibold text-white mb-4">Gameplay</h3>
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground">XP Multiplier</label>
                    <input type="number" defaultValue="1.0" step="0.1" className="w-full mt-1 px-3 py-2 rounded bg-white/5 border border-white/10 text-white text-sm" />
                  </div>
                </div>
              </Card>
                ...
                <div className="space-y-3">
                  <div>
                    <label className="flex items-center gap-2 cursor-pointer">
                      ...
                      <span className="text-xs text-muted-foreground">Mission Updates</span>
                    </label>
                  </div>
                  <div>
                    <label className="flex items-center gap-2 cursor-pointer">
                      <input type="checkbox" defaultChecked className="w-4 h-4" />
                      <span className="text-xs text-muted-foreground">Reward Notifications</span>
                    </label>
                  </div>
                </div>
              </Card>
