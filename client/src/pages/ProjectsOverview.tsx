  ...
  return (
    <div className="h-screen w-full bg-[#030305] text-foreground overflow-hidden font-sans selection:bg-primary/20 relative perspective-1000 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full h-full flex flex-col items-center justify-center">
        ...
        {/* The Core System */}
        <div className="relative w-[700px] h-[700px] flex items-center justify-center mt-16">
           
           {/* Orbital Rings */}
           <div className="absolute inset-0 rounded-full border border-white/[0.03] animate-orbit-reverse" style={{ animationDuration: '120s' }} />
           <div className="absolute inset-[80px] rounded-full border border-white/[0.05] animate-orbit" style={{ animationDuration: '80s' }} />
           <div className="absolute inset-[160px] rounded-full border border-dashed border-white/[0.08] animate-orbit-reverse" style={{ animationDuration: '60s' }} />
           ...
           <div className="absolute inset-0 animate-in fade-in duration-1000 delay-500">
              ...
              <div className="absolute top-1/2 left-1/2 w-0 h-0 flex items-center justify-center" style={{ transform: 'translate(0px, 250px)' }}>
