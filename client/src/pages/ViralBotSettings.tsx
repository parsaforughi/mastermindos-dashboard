...
export default function ViralBotSettings() {
  return (
      ...
      <div className="relative z-10 flex h-full w-full">
        ...
        <main className="flex-1 flex flex-col h-full overflow-hidden">
          <div className="flex-1 p-6 overflow-y-auto overflow-x-hidden custom-scrollbar">
            <div className="mb-6">
              <h1 className="text-3xl font-bold text-white mb-1">Bot Settings</h1>
              <p className="text-sm text-muted-foreground">Configure viral bot parameters and preferences</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 max-w-2xl">
              <Card className="p-4 border-white/10 bg-white/5 backdrop-blur-xl">
                <h3 className="text-sm font-semibold text-white mb-4">Tracking Settings</h3>
                <div className="space-y-3">
                  ...
                  <div>
                    <label className="text-xs text-muted-foreground">Content Sources</label>
                    <select className="w-full mt-1 px-3 py-2 rounded bg-white/5 border border-white/10 text-white text-sm">
              ...
              <Card className="p-4 border-white/10 bg-white/5 backdrop-blur-xl">
                ...
                <div className="space-y-3">
                  <div>
                    <label className="text-xs text-muted-foreground">Viral Threshold (Views)</label>
                    <input type="number" defaultValue="100000" className="w-full mt-1 px-3 py-2 rounded bg-white/5 border border-white/10 text-white text-sm" />
                  </div>
                  <div>
                    <label className="text-xs text-muted-foreground">Engagement Rate Minimum</label>
                    <input type="number" defaultValue="5" min="0" max="100" className="w-full mt-1 px-3 py-2 rounded bg-white/5 border border-white/10 text-white text-sm" />
                  </div>
                </div>
              </Card>
            </div>
