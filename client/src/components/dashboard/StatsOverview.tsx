...
const latencyData = [
  ...
  { time: "13:00", latency: 110 },
  { time: "14:00", latency: 95 },
...
function StatCard({ 
  ...
  return (
    <div className="glass-panel-interactive rounded-2xl p-5 relative overflow-hidden group h-full" data-testid={`stat-card-${label.toLowerCase().replace(/\s+/g, '-')}`}>
      <div className={cn(
...
export function StatsOverview() {
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-6" data-testid="stats-overview">
      ...
      <div className="glass-panel-interactive rounded-2xl p-5 lg:col-span-1 flex flex-col justify-between animate-in fade-in slide-in-from-bottom-4 duration-500 delay-300 group" data-testid="stat-card-latency">
