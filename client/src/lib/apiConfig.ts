export const API_CONFIG = {
  EXPLAINER_API: import.meta.env.VITE_EXPLAINER_API,
  VIP_API: import.meta.env.VITE_VIP_API,
  AUTO_DM_API: import.meta.env.VITE_AUTO_DM_API,
  VIRAL_BOT_API: import.meta.env.VITE_VIRAL_BOT_API,
